...
const Footer = () => {
  return (
    ...
    <div className='buider-Credit'>
        ...
        <a href="https://linkedin.com/in/samuel-aemro-911598356" className="footer-icon-link" target="_blank" rel="noopener noreferrer">
          <svg className="footer-svg-icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="https://instagram.com/samuel.ae_m" className="footer-icon-link" target="_blank" rel="noopener noreferrer">
          <svg className="footer-svg-icon" viewBox="0 0 24 24" fill="currentColor">
